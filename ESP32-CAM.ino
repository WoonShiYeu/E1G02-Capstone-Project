...
#include <Arduino.h>
#include <esp_now.h>
uint8_t mac_peer1[] = {0xC4, 0x5B, 0xBE, 0x4D, 0x91, 0x8E};
...
String recognize_face_matched_name[7] = {"ID:0","ID:1","ID:2","ID:3","ID:4","ID:5","ID:6"};
                ...
                <div id="sidebar">
                    ...
                    <nav id="menu">
                        ...
                        <div class="input-group" id="controlstate-group">
                            <label for="controlstate">Attendance Taking</label>
                            <div class="switch">
